...
(function() {
  var Server, argv, dns, iced, s, __iced_k, __iced_k_noop,
    __slice = [].slice;
  ...
  argv = require('optimist').usage("Usage: $0 [-p <port>] [-u <upstream>] <res1> <res2> ...").demand(['u']).argv;
  ...
  Server = (function() {
    ...
    Server.prototype.parse_args = function() {
      var a, _i, _len, _ref;
